...
팀원별 브랜치 이름은 다음처럼 사용합니다.

```text
준영 님:
feature/menu-list-screen
...
```text
feat: add menu list screen
feat: add nutrition summary screen
fix: fix menu checkbox state
...
화면 작업을 했다면 결과를 확인할 수 있도록 스크린샷을 함께 올리면 좋습니다.
